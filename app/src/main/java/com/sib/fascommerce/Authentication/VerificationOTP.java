...
//        });
    ...
    private void signInWithPhoneAuthCredential(PhoneAuthCredential credential) {
        Task<AuthResult> dismiss = mAuth.signInWithCredential(credential)
                .addOnCompleteListener(VerificationOTP.this, new OnCompleteListener<AuthResult>() {
                    @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            //verification successful we will start the profile activity
                            Intent intent = new Intent(VerificationOTP.this, Registration.class);
...
//                            Snackbar dismiss1 = snackbar.setAction("Dismiss", new View.OnClickListener() {
//                                @Override
//                                public void onClick(View v) {
//
//                                }
